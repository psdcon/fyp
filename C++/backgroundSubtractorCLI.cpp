...
Mat erodeDilate; //fg mask fg mask generated by MOG2 method
...
void processVideo(char* videoFilename) {
	...
	//** make objs for doing stuff https://www.youtube.com/watch?v=bSeFrPrqZ2A
	...
	while ((char)keyboard != 'q' && (char)keyboard != 27) {
		...
		erode(fgMaskMOG2, erodeDilate, erodeElement);
		...
		imshow("Erode dilate", erodeDilate);
