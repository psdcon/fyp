...
% datapath = '/home/titan/paul_connolly/videos/VID_20161106_113151__dilated_blurred_0.4-0.6';
...
%%
save(strcat(datapath, filesep, 'preds_2d.mat'), 'preds_2d')
save(strcat(datapath, filesep, 'preds_3d.mat'), 'preds_3d')
disp('Files saved. Generating Images...')
