...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.reader = vision.VideoFileReader('C:\\Users\\psdco\\Videos\\Inhouse\\480p\\VID_20161106_112413_720x480.mp4');
        
        % Create two video players, one to display the video,
        % and one to display the foreground mask.
        obj.videoPlayer = vision.VideoPlayer('Position', [0, 100, 700, 400]);
        obj.maskPlayer = vision.VideoPlayer('Position', [700, 100, 700, 400]);
        ...
        obj.detector = vision.ForegroundDetector('NumGaussians', 4, ...
            'NumTrainingFrames', 60, 'MinimumBackgroundRatio', 0.7 , 'LearningRate', 0.05);
